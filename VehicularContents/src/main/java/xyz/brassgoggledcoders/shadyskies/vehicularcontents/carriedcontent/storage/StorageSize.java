...
public enum StorageSize implements StringRepresentable {
    ...
    public static final StringRepresentableCodec<StorageSize> CODEC = StringRepresentable.fromEnum(StorageSize::values);
